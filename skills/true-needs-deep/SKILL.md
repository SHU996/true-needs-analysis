...
- **用户选 B/C** → 追问："你能从以下哪些方向补充？（可多选）" A) 我认识的某个具体的人 B) 我看到过某个帖子/视频 C) 我自己就是这个用户
- **场景选 B/C** → 追问："这个问题最可能在什么情况下发生？" A) 每天固定时间 B) 特定任务触发 C) 不定期，随机发生
- **痛点选 B/C** → 追问："用户目前最可能的凑合方式是？（可多选）" A) 手工/Excel 凑合 B) 用了别的工具但不满意 C) 直接放弃了没解决
...
**Q3. 资产价值：用户用了一年后，会因为以下哪些原因留下来？（可多选）**
- **A)** 数据沉淀——历史记录/积累的内容走了可惜
- **B)** 习惯养成——已经习惯了这套流程，不想换
- **C)** 关系绑定——其他人也在用，切换有成本
- **D)** 想不出留下来的理由
...
**护城河评估规则：**
- Q1 选 A + Q2 选了 A/B/C 中任意项 + Q3 选了 A/B/C 中任意项 → 护城河**强**
- 2 个维度满足 → 护城河**中**
- ≤1 个维度满足 → 护城河**弱**，在报告中标注"护城河不足，建议补充情绪价值或资产价值的设计"

**只有功能价值的产品容易陷入价格战。** 如果 Q2 只选了 D/E 且 Q3 只选了 D，明确提醒用户：除了"解决问题"，用户没有其他留下来的理由。
